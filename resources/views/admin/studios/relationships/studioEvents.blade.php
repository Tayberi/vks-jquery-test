    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-studioEvents">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($events as $key => $event)
                            <tr data-entry-id="{{ $event->id }}">
                                ...
                                <td>
                                    @foreach($event->studios as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-studioEvents:not(.ajaxTable)').DataTable({ buttons: dtButtons })
